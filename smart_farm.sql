...
CREATE TABLE `farm_record`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '农事记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `farm_task`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务工单' ROW_FORMAT = Dynamic;
...
INSERT INTO `farm_task` VALUES (5, 3, '今日采收', 'HARVEST', '采收成熟黄瓜，分级装箱', 7, 3, '全排', '2026-04-27 06:26:36', 'PENDING', '2026-04-27 01:26:36');
...
CREATE TABLE `harvest_record`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '采收记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notification`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息通知' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of notification
-- ----------------------------
INSERT INTO `notification` VALUES (1, 4, '记录审核通过', '您提交的浇水记录已审核通过', 'AUDIT_PASS', 1, '2026-04-27 01:26:36');
INSERT INTO `notification` VALUES (2, 6, '记录被驳回', '您提交的生长记录被驳回，请补充叶黄的具体位置', 'AUDIT_REJECT', 0, '2026-04-27 01:26:36');
...
INSERT INTO `notification` VALUES (6, 6, '收到新任务', '您有新任务：病虫害巡查，请及时处理', 'TASK_NEW', 0, '2026-04-27 01:26:36');
