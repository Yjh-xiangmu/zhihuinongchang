  ...
  <div class="shell">
    ...
    <div class="layout">
      <div class="sidebar">
        ...
        <router-link class="nav-item nav-ai" to="/worker/ai" active-class="active">
...
.nav-ai.active { background:linear-gradient(135deg,#e8f5f0,#f0eeff); color:var(--color-primary); }
.ai-dot { font-size:10px; color:var(--color-primary); }
